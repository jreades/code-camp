...
1. The rationale behind the usage of computers and computational methodologies for urban spatial science (and the social sciences more generally).
2. The range of tools that we use to _do_ urban spatial science, a sense of _why_ we use them, and _how_ they connect with tools used by practicing researchers and programmers. 
3. The fundamental concepts of programming used in Python so that you can 'read' Python code and begin to recognise how to do things using Python.
4. How programs and libraries are structured so that you code remains manageable and, above all, legible.
5. How your newly acquired coding skills can help you be _usefully_ lazy because that, ultimately, is what computers do: they make tedious, repetitive problems 'go away', though they often create or reveal much more complex, novel problems in turn.

Code Camp is all about building blocks: helping you to learn the fundamentals so that when classes start you (hopefully) feel a _little_ less lost and _lot_ less stressed. We can't make learning to code _easy_ any more than learning to speak French or Chinese (or English!) easy, but if you work your way through these lessons it will be _easier_ to hit the ground running in Week 1.
...
sequencing = [
  [str(time(0,10,0)), 'Doing Urban Spatial Science'],
  [str(time(0,25,0)), 'Background: *Why* We Do What We Do'],
  [str(time(0,45,0)), 'Tools of the Trade: *How* We Do What We Do'],
  [str(time(0,45,0)), 'The Basics: Variables, Operators & Precedence'],
  [str(time(0,45,0)), 'Exceptions: What to Do When Things Go Wrong'],
  [str(time(0,45,0)), 'Writing Code: A Matter of Style'],
  [str(time(0,45,0)), 'Boolean Logic: Comparisons, Conditions & George Boole'],
  [str(time(0,45,0)), 'Recap 1'],
  [str(time(0,45,0)), 'Lists: Making a List (and Checking it Twice)'],
  [str(time(0,45,0)), 'Dicts: Look it up in the Dictionary'],
  [str(time(0,45,0)), 'Loops: Let\'s Iterate This'],
  [str(time(0,45,0)), 'Recap 2'],
  [str(time(0,45,0)), 'Functions: Automate All the Things'],
  [str(time(0,45,0)), 'Packages: Giving Yourself a Present'],
  [str(time(0,45,0)), 'Classes: How to Objectify Things in Python'],
  [str(time(0,45,0)), 'The Terminal: No More Buttons to Press'],
]
...
Markdown(tabulate(
  table,
  headers=["Lesson","Time Needed","Covers","Link"],
