...
For example, to calculate 2 plus 2 using Python type `2 + 2` and run the code.

*HINT*: To run ensure you type your code in your working environment (either [locally](../setup/install.qmd) or [online](../setup/no_install.qmd)) and click the the 'Run' button (usually, a sideways-pointing triangle).
...
[![What is Python?](http://img.youtube.com/vi/aXKVOLwpDg8/0.jpg)](http://www.youtube.com/watch?v=aXKVOLwpDg8)

[![Python Overview](http://img.youtube.com/vi/Hn4FbT4wMms/0.jpg)](http://www.youtube.com/watch?v=Hn4FbT4wMms)

[![Why You Should Learn Python Programming](http://img.youtube.com/vi/G8brQdClo9s/0.jpg)](http://www.youtube.com/watch?v=G8brQdClo9s)
