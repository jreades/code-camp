...
*DISCLAIMER: This lesson is heavily based on the [official Python Documentation](https://docs.python.org/3/tutorial/errors.html) about Errors and Exceptions. Check it out for further examples.*
