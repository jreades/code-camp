...
Once it's installed, you *can* use the Terminal or Command Prompt as above, or you may find you've got some additional options (e.g. Anaconda Prompt on Windows) that are slightly more user-friendly.
