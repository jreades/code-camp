...
This short video shows how to copy code from the Code Camp micro-site over to VS Code (so that you can save your work), and from there into the Python 'interpreter' (what you have just installed):
