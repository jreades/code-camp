...
To be clear: Code Camp does *not* require you to buy a new computer! The [no install options](./no_install.qmd)) page is all you need for Code Camp. *This* page is intended to help you gauge whether your computer might encounter issues doing spatial analysis once term starts. 
...
- How much RAM does your computer have? [Help](https://www.macworld.co.uk/how-to/mac/much-ram-need-more-3793418/).
- How much free disk space does your computer have? [Help](https://www.macworld.com/article/2972775/how-to-check-a-mac-free-hard-drive-space.html).

### Windows

You will need to look up:

- How much RAM does your computer have? [Help](https://uk.pcmag.com/components/133375/how-much-ram-do-i-have-in-my-pc).
- How much free disk space does your computer have? [Help](https://www.lifewire.com/how-to-check-free-hard-drive-space-in-windows-2619187).
...
- What Operating System and Version is your computer running? [Help](https://support.apple.com/en-gb/HT201260).

### Windows

- What Operating System and Version is your computer running? [Help](https://support.microsoft.com/en-gb/help/13443/windows-which-version-am-i-running).
