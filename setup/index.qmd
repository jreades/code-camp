...
You are welcome to run Code Camp code on your own computer (see: [install options](./install.qmd)), but you should also look at the [no install options](./no_install.qmd) that will allow you to learn (and run) Python anywhere and any time.
